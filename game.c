...
int game(App* app, char* name)
{
    ...
    Button* goal_nr = menu_button_text(app, 194, 0, 50, 50, "250", font, color_select(WHITE));
    ...
    Button* player1_name = menu_button_text(app, 15, 65, 100, 70, name, font, color_select(WHITE));
    Button* player2_name = menu_button_text(app, 25, 165, 100, 70, "Stoffe", font, color_select(WHITE));
    Button* player3_name = menu_button_text(app, 25, 265, 100, 70, "Victor", font, color_select(WHITE));
    Button* player4_name = menu_button_text(app, 25, 365, 100, 70, "Alma", font, color_select(WHITE));

    Button* player1_score = menu_button_text(app, 150, 65, 70, 70, "", font, color_select(WHITE));
    Button* player2_score = menu_button_text(app, 150, 65, 70, 70, "", font, color_select(WHITE));
    Button* player3_score = menu_button_text(app, 150, 65, 70, 70, "", font, color_select(WHITE));
    Button* player4_score = menu_button_text(app, 150, 65, 70, 70, "", font, color_select(WHITE));
    ...
    Button* return_button = menu_button_background(app, 1213, 10, 35, 35, "./resources/menuButton.png");
    ...
    while (app->running) {
        ...
        if (fruit_collision(player1->snake, fruits, nr_of_fruits)) {
            ...
            player1_score = menu_button_text(app, 150, 65, 70, 70, buffer, font, color_select(WHITE));
        ...
        render_button(app, player1_name);
        render_button(app, player1_score);

        render_button(app, player2_name);
        render_button(app, player3_name);
        render_button(app, player4_name);
